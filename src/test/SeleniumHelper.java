...
public class SeleniumHelper {
    ...
    public void printMeetings(String day, HashMap<String, HashMap<String, Integer>> map) throws Exception {
        if (checkIfInputDayIsValid(day)) {
            ...
            throw new Exception("Invalid input for Day of the week");
    }
}
